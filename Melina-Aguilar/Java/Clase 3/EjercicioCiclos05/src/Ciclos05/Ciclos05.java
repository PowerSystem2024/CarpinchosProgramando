/*
Ejercicio 5: Realizar un juego para adivinar un numero, para ellos generar un
numero aleatorio entre 0-100, y luego ir pidiendo numeros indicando "es mayor" o
"es menor" segun sea mayor o menos con respecto a N. El proceso termina cuando el
