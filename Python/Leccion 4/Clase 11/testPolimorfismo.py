...
empleado = Empleado("Fernando", 500000)  # Creamos un empleado
imprimirDetalles(empleado)  # Imprimimos los detalles del empleado

print()

# Crear una instancia de Gerente
gerente = Gerente("Mercedes", 1000000, "Sistemas")  # Crea un gerente llamado Wanda con un salario y departamento
