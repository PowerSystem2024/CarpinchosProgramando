...
const educacion = ref([
  {fecha: '2024', title: 'Técnicatura Universitaria en Programacion - UTNFRSR', descripcion: 'Incumbencias Profesionales: Operación y programación de computadoras, desarrollo de programas en distintos lenguajes, análisis y control de sistemas informáticos.', enlace:'http:www.direccion.com'},
  {fecha: '2024', title: 'Curso Activá tu Talento - Junior Achievement', descripcion: 'Objetivo: Potenciar competencias transversales para el trabajo e identificar caminos que favorezcan la empleabilidad del alumno, a través de actividades prácticas.', enlace:'http:www.direccion.com'},
  {fecha: '2023', title: 'Tecnicatura Secundaria en Electrónica - Instituto Leonardo Murialdo', descripcion: 'Incumbencias Profesionales: Montaje e instalación, operación y manutención de componentes, productos, equipos e instalaciones de electrónica analógica y/o digital; realización de proyectos, diseños y desarrollos de tecnología estándar', enlace:'http:www.direccion.com'},
  {fecha: '2021', title: 'Curso Yo Puedo Programar - Junior Achievement', descripcion: 'Objetivo: Aprender programación en los lenguajes HTML, CSS y JavaScript, crear una página web y desarrollar habilidades para el presente y el futuro.', enlace:'http:www.direccion.com'},
]);
</script>
...
ul::before {
  ...
  background: #bcbf93; /* Color de la línea */
