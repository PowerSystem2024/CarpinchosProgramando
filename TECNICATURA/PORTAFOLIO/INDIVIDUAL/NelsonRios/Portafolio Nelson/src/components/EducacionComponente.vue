...
const educacion = ref([
  {fecha: '2024', title: 'Técnicatura Universitaria en Programacion', descripcion: 'Universidad Tecnologica Nacional - Facultad Regional San Rafael. En este trayecto formativo incursionamos en lenguajes de programación, desarrollo de programas en distintos lenguajes, análisis y control de sistemas informáticos.'},
  {fecha: '2022', title: 'Desarrollador Full Stack Java', descripcion: 'En el marco del programa nacional Argentina programa, inicie mi recorrido por el mundo de la programacion, desde fundamentos de programacion con pseudocódigo, luego profundizando en Java, JDBC, Maria DB, Java Swing, HTML, CSS, Javascript'},
]);
</script>
...
ul li .title {
  ...
  font-weight: 800; /* Hace el texto del título un poco más grueso */
  font-size: 25px;
}
