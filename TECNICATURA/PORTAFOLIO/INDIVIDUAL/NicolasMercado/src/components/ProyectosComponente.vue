<script setup>
import proyecto1 from "@/assets/proyecto.png";
import { ref } from 'vue';
...
misProyectos.value = [
    {
        ...
        descripcion: "En este proyecto, realizo transmisiones en vivo jugando diversos videojuegos, donde exploro en profundidad trucos, características y estrategias de cada juego. Además, colaboro activamente con la comunidad, respondiendo preguntas, compartiendo consejos y creando un ambiente interactivo donde los espectadores pueden aprender y disfrutar junto a mi.",
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Desarrollador de videojuego",
        descripcion: "Tengo un sueño, el cual es convertirme en desarrollador de videojuegos y hacer mi juego propio, un videojuego emotivo, divertido e inspirador para toda la comunidad en general"
    }
];
</script>
