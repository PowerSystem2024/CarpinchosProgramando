...
let persona1 = new Persona("Melina", "Aguilar", 22);
console.log(persona1.toString());

let persona2 = new Persona("Ana Paula", "Rios Garin", 19);
console.log(persona2.toString());
console.log();

//Prueba Clase Empleado
let empleado1 = new Empleado("Nelson", "Rios", 39, 2000000);
console.log(empleado1.toString());

let empleado2 = new Empleado("Nicolas", "Mercado", 23, 1500000);
console.log(empleado2.toString());
console.log();

//Prueba Clase Cliente
let cliente1 = new Cliente("Mariana", "Aguilera", 29, new Date());
console.log(cliente1.toString());

let cliente2 = new Cliente("Wanda", "Lanatta", 23, new Date());
