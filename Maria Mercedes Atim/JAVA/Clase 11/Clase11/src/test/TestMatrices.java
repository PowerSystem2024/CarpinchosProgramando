...
public class TestMatrices {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("En la matriz edades, en la fila: 0, columna 0 está el numero: " + edades[0][0]);
        System.out.println("En la matriz edades, en la fila: 0, columna 1 está el numero: " + edades[0][1]);
        System.out.println("En la matriz edades, en la fila: 1, columna 0 está el numero: " + edades[1][0]);
        System.out.println("En la matriz edades, en la fila: 1, columna 1 está el numero: " + edades[1][1]);
        System.out.println("En la matriz edades, en la fila: 2, columna 0 está el numero: " + edades[2][0]);
        System.out.println("En la matriz edades, en la fila: 2, columna 1 está el numero: " + edades[2][1]);
        ...
        for (int fila = 0; fila < edades.length; fila++) { // Recorremos las filas de la matriz
            for (int columna = 0; columna < edades[fila].length; columna++) { // Recorremos las columnas de la fila actual
                ...
                System.out.print("[" + edades[fila][columna] + "] "); // Imprimimos el número con corchetes
            }
            System.out.println(); // Saltamos a la siguiente línea después de imprimir una fila
        }
...
//        }
        ...
        personas[0][1] = new Persona("Wanda");
        personas[0][2] = new Persona("Nelson");
        personas[1][0] = new Persona("Mariana");
        personas[1][1] = new Persona("Ana Paula");
